      ...
      <div className="analytics-grid">
        ...
        <div className="analytics-stat">
          ...
          <div className="analytics-info">
            ...
            <div className="analytics-label">Total Volume (BLUE)</div>
          </div>
        </div>
        ...
        <div className="analytics-stat">
          ...
          <div className="analytics-info">
            ...
            <div className="analytics-label">Total Winnings (BLUE)</div>
          </div>
        </div>
        ...
        <div className="analytics-stat">
          ...
          <div className="analytics-info">
            ...
            <div className="analytics-label">Avg Prize Pool (BLUE)</div>
          </div>
        </div>
        ...
        <div className="analytics-stat">
          ...
          <div className="analytics-info">
            ...
            <div className="analytics-label">Largest Prize (BLUE)</div>
          </div>
        </div>
      </div>
      ...
      <div className="current-round-section">
        ...
        <div className="current-round-stats">
          <div className="current-stat">
            ...
            <span className="current-value">{parseFloat(analytics.currentRoundPool).toFixed(2)} BLUE</span>
          </div>
          <div className="current-stat">
