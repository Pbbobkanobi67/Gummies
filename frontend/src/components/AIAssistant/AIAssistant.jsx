...
const GAME_EXPLANATIONS = {
  progressive: {
    ...
    howToPlay: [
      'Buy a ticket for 100 BLUE tokens',
  ...
  raffle: {
    ...
    howToPlay: [
      'Buy raffle tickets (10 BLUE each)',
  ...
  default: {
    title: 'Blue Casino',
    description: 'Welcome to Blue Casino! Choose a game to get started.',
    howToPlay: [
                ...
                <>
                  <div className="current-bet-display">
                    ...
                    <div className="bet-summary">
                      ...
                      <span className="bet-detail">
                        <strong>Amount:</strong> {currentBet?.betAmount || '0'} BLUE
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="strategy-card">
                    ...
                    <div className="strategy-recommendation">
                      ...
                      <div className="rec-item">
                        ...
                        <span className="rec-value">{suggestion.suggestedAmount} BLUE</span>
                      </div>
                      <div className="rec-item">
