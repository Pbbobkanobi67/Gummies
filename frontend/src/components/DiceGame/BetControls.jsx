...
function BetControls({
  ...
  const getNumberOptions = () => {
    switch (betType) {
      ...
      case BetType.UNDER:
        return [2, 3, 4, 5, 6]; // Can't bet UNDER 1
      default:
        return [];
    }
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="amount-section">
          ...
          {limits && (
            <span className="limit-info">
              Min: {limits.minBet} | Max: {limits.maxBet} BLUE
            </span>
          )}
        </div>
        ...
        <div className="bet-info">
          ...
          <div className="info-row highlight">
            ...
            <span className="payout">{parseFloat(potentialPayout).toFixed(2)} BLUE</span>
          </div>
        </div>
