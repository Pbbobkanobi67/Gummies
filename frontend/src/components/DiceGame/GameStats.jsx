    ...
    <div className="game-stats">
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <span className="stat-value">{parseFloat(stats.houseBankroll).toLocaleString()} BLUE</span>
        </div>
        ...
        <div className="stat-card">
          ...
          <span className="stat-value">{parseFloat(stats.totalWagered).toLocaleString()} BLUE</span>
        </div>

        <div className="stat-card">
          <span className="stat-label">Total Paid Out</span>
          <span className="stat-value">{parseFloat(stats.totalPaidOut).toLocaleString()} BLUE</span>
        </div>
      </div>
