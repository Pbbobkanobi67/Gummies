    ...
    <div className="jackpot-display">
      <div className="jackpot-amount">
        ...
        <span className="jackpot-value">
          {parseFloat(stats.jackpotPool).toLocaleString()} BLUE
        </span>
      </div>
      ...
      <div className="payout-tiers">
        <div className="payout-tier jackpot-tier">
          ...
          <span className="tier-payout">{parseFloat(payouts?.jackpot || 0).toLocaleString()} BLUE</span>
        </div>
        <div className="payout-tier">
          <span className="tier-match">3/4 Match</span>
          <span className="tier-payout">{parseFloat(payouts?.match3 || 0).toLocaleString()} BLUE</span>
        </div>
        <div className="payout-tier">
          <span className="tier-match">2/4 Match</span>
          <span className="tier-payout">{parseFloat(payouts?.match2 || 0)} BLUE</span>
        </div>
      </div>
      ...
      <div className="jackpot-stats">
        ...
        <div className="stat-item">
          ...
          <span>{stats.ticketPrice} BLUE</span>
        </div>
      </div>
    </div>
  );
