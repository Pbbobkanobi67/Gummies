...
async function main() {
  ...
  console.log('  Min Tickets:', hre.ethers.formatEther(await raffle.minTickets()), 'BLUE');
  console.log('  Max Tickets:', hre.ethers.formatEther(await raffle.maxTickets()), 'BLUE');
